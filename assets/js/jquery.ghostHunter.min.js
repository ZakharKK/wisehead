...
(function( $ ) {
  ...
  $.fn.ghostHunter.defaults = {
    ...
    onPageLoad      : false,
    onKeyUp       : false,
    result_template   : "<div class='display-block'><h4 class='display'>{{splitTitleRight}}</h4><a href='{{link}}''><h2 class='big-display'>{{splitTitleLeft}}</h2></a></div>",
    info_template   : "",
  ...
  var pluginMethods = {
    ...
    /*  Here we load all of the blog posts to the index. 
      ...
      var index     = this.index,
        ...
        obj     = {limit: "all",  include: "tags", filter: "tags: 'jobs'" };
      ...
      $.get(ghost.url.api('posts',obj)).done(function(data){
        ...
        searchData.forEach(function(arrayItem){
          ...
          let splitTitleLeft = parsedData.title.split(",")[0];
          let splitTitleRight = parsedData.title.split(",")[1];

          index.add(parsedData)
          blogData[arrayItem.id] = {splitTitleLeft: splitTitleLeft, splitTitleRight: splitTitleRight, title: arrayItem.title, description: arrayItem.meta_description, pubDate: tempdate, link: arrayItem.url};
        });
      });
      this.isInit = true;
    },
    ...
    find      : function(value){
      ...
      try {
        ...
        console.log('Remove default pagination and results ERROR: ' + e);
      }
      ...
      try {
        ...
        console.log('Blocks styles ERROR: ' + e);
      }
